...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://github.com/SuhailTechInfo/Suhail-Md/blob/main/lib/assets/suhail.jpg?raw=true" lib/assets/Nzi MD pic.png; // SET LOGO FOR IMAGE 
...
module.exports = {
  ...
  VERSION : process.env.VERSION || "2.3.8",
  caption : global.caption || "" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴜʜᴀɪʟ²²¹-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
 
  author : process.env.PACK_AUTHER|| "Nzi",
  packname: process.env.PACK_NAME || "Housefly",
  botname : process.env.BOT_NAME  || "Nzi MD,
  ownername:process.env.OWNER_NAME|| "Nzi",
